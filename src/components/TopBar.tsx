...
export function TopBar() {
  ...
  return (
    <div className="topbar">
      <div className="scope glass glass--soft" role="tablist" aria-label="Ledger scope">
...
function RoundButton({ label, onClick, active, badge, children }: RoundButtonProps) {
  return (
    <button className="round-btn surface glass glass--soft" data-active={active} onClick={onClick} aria-label={label}>
      {children}
